...
private:
    ...
    //////
    std::vector<float> crop_cluster_size_;
    ...
    float computeBoundingBoxByOrientation(const std::vector<float>& xs,
                                          ...
                                          float& w,
                                          float& phi);
    void fitOrientedBoundingBox(const pcl::PointCloud<pcl::PointXYZI>::Ptr pc,
                                visualization_msgs::Marker& marker);
    void fitBoundingBox(const pcl::PointCloud<pcl::PointXYZI>::Ptr pc,
                        visualization_msgs::Marker& marker);
    void clusterInSegment(const pcl::PointCloud<pcl::PointXYZI>::Ptr pc,
                          const double& cluster_distance,
                          visualization_msgs::MarkerArray& objs);
    void cluster(const pcl::PointCloud<pcl::PointXYZI>::Ptr pc,
                 visualization_msgs::MarkerArray& objs);
    void crop(const pcl::PointCloud<pcl::PointXYZI>::Ptr pc,
